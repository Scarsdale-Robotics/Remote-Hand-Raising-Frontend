...
<div class="container">
    ...
    <div class="row justify-content-center">
        <h2 id="inputformsbox">Sign Up</h2>
    </div>
    <div class="row justify-content-center">
         <h6 id="smalltext">Please fill in this form to create a account!</h6>
    </div>
    <br>
    <div class="row justify-content-center">
...
<form action="#" method="post"
 oninput='up2.setCustomValidity(up2.value != up.value ? "Passwords do not match." : "")'>
  ...
  <div class="form-group">
    ...
    <small id="smalltext" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
  ...
  <div class="form-group">
    <label id="inputformsbox" for="password2">Confirm Password</label>
    <input id="inputformsinput" type="password" class="form-control" id="password2" placeholder=""required name=up2>
  </div>
